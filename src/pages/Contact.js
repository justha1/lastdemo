      ...
      <div className="col-span-4 bg-gray-50 px-8 py-10 bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li className="mb-6 flex items-start text-left">
            ...
            <div>
              <a className="cursor-pointer font-serif text-base md:text-lg" href="#">xxxx@gmail.com</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <a className="cursor-pointer font-serif text-base md:text-lg" href="#">JustHa</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <p className="font-serif text-base md:text-lg">JustHa</p>
