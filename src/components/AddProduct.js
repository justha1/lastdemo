      ...
      <form onSubmit={handleSubmit} className='mb-8'>
        <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
          <div className="w-full">
            ...
            {errors.title && <p className="text-red-500 font-light text-[12px]">{errors.title}</p>}
          </div>
          <div className="w-full">
            ...
            {errors.price && <p className="text-red-500 font-light text-[12px]">{errors.price}</p>}
          </div>
          <div>
          ...
          <div>
            ...
            {errors.image && <p className="text-red-500 font-light text-[12px]">{errors.image}</p>}
          </div>
          <div className="sm:col-span-2">
            ...
            {errors.description && <p className="text-red-500 font-light text-[12px]">{errors.description}</p>}
          </div>
        </div>
