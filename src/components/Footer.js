...
const Footer = () => {
  return (
      <footer className='bg-white rounded-lg shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] m-4 mt-auto '>
          <div className='w-full max-w-screen-xl mx-auto p-4 md:py-8'>
              ...
              <span className='block text-sm sm:text-center bg-gradient-to-r  from-black to-blue-500 bg-clip-text text-transparent'>© 2023 <a href='https://www.facebook.com/tran.ha.787843' className='hover:underline'>JustHa</a>. All Rights Reserved.</span>
          </div>
      </footer>
);
};
